    ...
    <main className="page">
          ...
          <div className="flex flex-col gap-2">
            {cours.map((c) => (
              <Link
                ...
                className="flex items-center justify-between rounded-lg border border-gray-200 bg-gray-50 p-3 hover:bg-gray-50"
              >
      ...
      <section className="mb-10">
        ...
        {absences.length === 0 ? (
          ...
          <div className="flex flex-col gap-2">
            {absences.map((a) => (
              <div key={a.id} className="rounded-lg border border-gray-200 bg-gray-50 p-3 text-sm text-gray-700">
                {a.coursTitre}
